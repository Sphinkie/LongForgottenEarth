...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
StarDetails* StarDetails::GetStarDetails(const StellarClass& sc)
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
StarDetails* StarDetails::CreateStandardStarType(const std::string& specTypeName,
                                    float _temperature,
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
StarDetails* StarDetails::GetNeutronStarDetails()
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
StarDetails* StarDetails::GetBlackHoleDetails()
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
StarDetails* StarDetails::GetBarycenterDetails()
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::InitializeStarTextures()
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setRadius(float _radius)
{
    radius = _radius;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setTemperature(float _temperature)
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setSpectralType(const std::string& s)
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setKnowledge(uint32 _knowledge)
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::addKnowledge(uint32 _knowledge)
{
    knowledge |= _knowledge;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setBolometricCorrection(float correction)
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setTexture(const MultiResTexture& tex)
{
    texture = tex;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setModel(ResourceHandle rh)
{
    model = rh;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setOrbit(Orbit* o)
{
    orbit = o;
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setOrbitBarycenter(Star* bc)
{
    barycenter = bc;
    computeOrbitalRadius();
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setOrbitalRadius(float r)
{
    if (orbit != NULL)
        orbitalRadius = r;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setVisibility(bool b)
{
    visible = b;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setRotationElements(const RotationElements& re)
{
    rotationElements = re;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void StarDetails::setEllipsoidSemiAxes(const Vec3f& v)
{
    semiAxes = v;
}
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
UniversalCoord Star::getPosition(double t) const
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
MultiResTexture Star::getTexture() const
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
ResourceHandle Star::getModel() const
{
...
/* ------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------- */
void Star::setRotationElements(const RotationElements& re)
{
    details->setRotationElements(re);
}
