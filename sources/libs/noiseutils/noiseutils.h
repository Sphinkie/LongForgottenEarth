...
///
/// <b>Internal NoiseImage Structure</b>
///
...
class NoiseImage
{
  ...
  public:
    ...
    /// It is considered an error if the specified dimensions are not
    /// positive.
    NoiseImage (int width, int height);

    /// Copy constructor.
    ///
    /// @throw noise::ExceptionOutOfMemory Out of memory.
    NoiseImage  (const NoiseImage& rhs);
    ...
    NoiseImage& operator= (const NoiseImage& rhs);
    ...
    /// This method only moves the buffer pointer so this method is very
    /// quick.
    void TakeOwnership (NoiseImage& source);
  ...
  private:
    ...
    /// you live in the USA.
    void CopyImage (const NoiseImage& source);
...
/// - Pass an NoiseImage object to the SetSourceImage() method.
...
class WriterBMP
{
  ...
  public:
    ...
    void SetSourceImage (NoiseImage& sourceImage)
    {
...
///
/// To specify a background image, pass an NoiseImage object to the
...
/// - Pass a NoiseMap object to the SetSourceNoiseMap() method.
/// - Pass an NoiseImage object to the SetDestImage() method.
/// - Pass an NoiseImage object to the SetBackgroundImage() method (optional)
...
class RendererImage
{
  ...
  public:
    ...
    void SetBackgroundImage (const NoiseImage& backgroundImage)
    {
    ...
    /// The destination image must exist throughout the lifetime of this
    /// object unless another image replaces that image.
    void SetDestImage (NoiseImage& destImage)
    {
  ...
  private:
    ...
    const NoiseImage* m_pBackgroundImage;

    /// A pointer to the destination image.
    NoiseImage* m_pDestImage;
