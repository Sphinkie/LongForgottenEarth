...
{ 
  ...
  String matName = "DynLine" + StringConverter::toString(matIndex++); 
  MaterialPtr materialPtr = MaterialManager::getSingleton().create(matName, 
              ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME); 
  materialPtr->setAmbient(LineColour); 
  materialPtr->setSelfIllumination(LineColour); 
  setMaterial(matName);
} 
...
{ 
  getMaterial()->setAmbient(LineColour);
  getMaterial()->setSelfIllumination(LineColour);
} 
