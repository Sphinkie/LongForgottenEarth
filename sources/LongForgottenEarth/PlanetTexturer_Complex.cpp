/* ------------------------------------------------------------------------- */
// File       : PlanetTexturer_Complex.cpp
...
/// Contructeur
/* ------------------------------------------------------------------------- */
PlanetTexturer_Complex::PlanetTexturer_Complex()
{
		// Lacunarity :  Changing this value produces slightly different relief.
	...
	// Définit le "twistiness" des differents reliefs
  	MOUNTAINS_TWIST = 1.0;
	HILLS_TWIST     = 1.0;
	BADLANDS_TWIST  = 1.0;
	...
	CONTINENT_HEIGHT_SCALE = (1.0 - mSeaLevel) / 4.0;
...
/** 
C'est la fonction du tutoriel qui comporte beaucoup de modules (donc longue
à générer). Elle génère une image avec un certain réalisme de relief.

This program demonstrates how to use the libnoise library to generate
terrain elevations for a complex planetary surface that has the size of the earth.
...
*/
/* ------------------------------------------------------------------------- */
void PlanetTexturer_Complex::createTexture(String BitmapName)
{
	DEBUG_LOG(">> createComplexPlanet()");
  ...
  baseContinentDef_pe0.SetSeed (mSeed + 0);
  ...
  baseContinentDef_cu.AddControlPoint (-2.0000 + mSeaLevel,-1.625 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint (-1.0000 + mSeaLevel,-1.375 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 0.0000 + mSeaLevel,-0.375 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 0.0625 + mSeaLevel, 0.125 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 0.1250 + mSeaLevel, 0.250 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 0.2500 + mSeaLevel, 1.000 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 0.5000 + mSeaLevel, 0.250 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 0.7500 + mSeaLevel, 0.250 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 1.0000 + mSeaLevel, 0.500 + mSeaLevel);
  baseContinentDef_cu.AddControlPoint ( 2.0000 + mSeaLevel, 0.500 + mSeaLevel);
  ...
  baseContinentDef_pe1.SetSeed (mSeed + 1);
  ...
  continentDef_tu0.SetSeed (mSeed + 10);
  ...
  continentDef_tu1.SetSeed (mSeed + 11);
  ...
  continentDef_tu2.SetSeed (mSeed + 12);
  ...
  continentDef_se.SetBounds (mSeaLevel - 0.0375, mSeaLevel + 1000.0375);
...
DEBUG_LOG(">> generateTerrain");
  ...
  terrainTypeDef_tu.SetSeed (mSeed + 20);
  ...
  terrainTypeDef_te.AddControlPoint (SHELF_LEVEL + mSeaLevel / 2.0);
  terrainTypeDef_te.AddControlPoint (1.00);
...
DEBUG_LOG(">> generateMountains");
  ...
  mountainBaseDef_rm0.SetSeed (mSeed + 30);
  ...
  mountainBaseDef_rm1.SetSeed (mSeed + 31);
  ...
  mountainBaseDef_tu0.SetSeed (mSeed + 32);
  ...
  mountainBaseDef_tu1.SetSeed (mSeed + 33);
  ...
  mountainousHigh_rm0.SetSeed (mSeed + 40);
  ...
  mountainousHigh_rm1.SetSeed (mSeed + 41);
  ...
  mountainousHigh_tu.SetSeed (mSeed + 42);
  ...
  mountainousLow_rm0.SetSeed (mSeed + 50);
  ...
  mountainousLow_rm1.SetSeed (mSeed + 51);
...
DEBUG_LOG(">> generateHills");
  ...
  hillyTerrain_bi.SetSeed (mSeed + 60);
  ...
  hillyTerrain_rm.SetSeed (mSeed + 61);
  ...
  hillyTerrain_tu0.SetSeed (mSeed + 62);
  ...
  hillyTerrain_tu1.SetSeed (mSeed + 63);
...
DEBUG_LOG(">> generatePlains");
  ...
  plainsTerrain_bi0.SetSeed (mSeed + 70);
  ...
  plainsTerrain_bi1.SetSeed (mSeed + 71);
...
DEBUG_LOG(">> generateBadlands");
  ...
  badlandsSand_rm.SetSeed (mSeed + 80);
  ...
  badlandsSand_vo.SetSeed (mSeed + 81);
  ...
  badlandsCliffs_pe.SetSeed (mSeed + 90);
  ...
  badlandsCliffs_tu0.SetSeed (mSeed + 91);
  ...
  badlandsCliffs_tu1.SetSeed (mSeed + 92);
...
DEBUG_LOG(">> generateRivers");
  ...
  riverPositions_rm0.SetSeed (mSeed + 100);
  ...
  riverPositions_rm1.SetSeed (mSeed + 101);
  ...
  riverPositions_tu.SetSeed (mSeed + 102);
...
DEBUG_LOG(">> scale mountains");
  ...
  scaledMountainousTerrain_pe.SetSeed (mSeed + 110);
...
DEBUG_LOG(">> scale hills ");
  ...
  scaledHillyTerrain_pe.SetSeed (mSeed + 120);
...
DEBUG_LOG(">> final planet");
  ...
  continentalShelf_rm.SetSeed (mSeed + 130);
  ...
  continentalShelf_cl.SetBounds (-0.75, mSeaLevel);
  ...
  continentsWithBadlands_pe.SetSeed (mSeed + 140);
  ...
  continentsWithRivers_se.SetBounds (mSeaLevel, CONTINENT_HEIGHT_SCALE + mSeaLevel);
  continentsWithRivers_se.SetEdgeFalloff (CONTINENT_HEIGHT_SCALE - mSeaLevel);
  ...
  // Note pour les planetmap, on n'a pas besoin de convertir en mètres
  ////////////////////////////////////////////////////////////////////////////
...
//  finalPlanet.SetSourceModule (0, finalPlanet_sb);
	...
	// On memorise le résultat final de la combinaison de modules
	// constituant la représentation mathématique de la planete.
	noise::module::Cache finalPlanet;
	finalPlanet.SetSourceModule (0, unscaledFinalPlanet);


	/************************************************************************/
	/*  Create the elevation grid and resulting images                      */
	/************************************************************************/
	DEBUG_LOG(">> Create the elevation grid and resulting images");
	NoiseMapBuilderSphere planet;
	NoiseMap elevGrid;
	...
	planet.Build ();
	DEBUG_LOG("   planet build");

	this->generateColormap (elevGrid,"planet_complex_colormap0.bmp", DEFAULT_PLANET, true);
	this->generateColormap (elevGrid,"planet_complex_colormap1.bmp", TEMPERATE_1, true);
	this->generateColormap (elevGrid,"planet_complex_colormap2.bmp", TEMPERATE_2, true);
	this->generateColormap (elevGrid,"planet_complex_colormap3.bmp", TERRESTRIAL, true);
	this->generateColormap (elevGrid,"planet_complex_colormap4.bmp", TERRESTRIAL_2, true);
	this->generateColormap (elevGrid,"planet_complex_colormap5.bmp", ROCK, true);

	this->generateColormap (elevGrid,BitmapName+".bmp", TERRESTRIAL_2, true);

	this->flattenSea(elevGrid);
  
	this->generateSpecMap  (elevGrid,"planet_complex_specmap.bmp");
	this->generateBumpMap  (elevGrid,"planet_complex_bumpmap.bmp");
	this->generateNormalMap(elevGrid,"planet_complex_normalmap.bmp");

	this->generateNormalMap(elevGrid,BitmapName+"_NM.bmp");

	// this->scalePlanetInMeters(elevGrid, -8192, +8192, 44236800);	// idem Terre
	// this->generateTerragenMap(elevGrid,"planet_complex.ter");
	// this->generateRawMap     (elevGrid,"planet_complex.raw");
}
...
/* ------------------------------------------------------------------------- */
void PlanetTexturer_Complex::CheckParameters()
{
	// TODO : appeler aussi la fonction de la classe mère

	TRACE(">> PlanetTexturer_Complex::CheckParameters()");
