...
protected:
	...
	int             mCatalogNumber; ///< No de l'étoile dans le catalogue Celestia
	Real            mAbsMag;        ///< magnitude absolue
	Vector3         mPosition;      ///< Position de l'étoile par rapport à GalaxyNode.
	...
	Billboard*      mSprite;        ///< Sprite de l'étoile
